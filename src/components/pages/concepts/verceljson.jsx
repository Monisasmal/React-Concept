...
<h3 className="text-xl font-bold mb-4">vercel.json Example</h3>
...
What is <span className="text-indigo-600">vercel.json?</span>
</h1>
...
vercel.json is a configuration file used by
the Vercel platform to customize deployment
settings, routing, and serverless functions.
</p>
...
<li>✔ Serverless function setup</li>
...
<ul className="text-sm space-y-2">
<li>1. Vercel reads config file</li>
<li>2. routes and settings applied</li>
<li>3. build rules executed</li>
<li>4. application deployed</li>
</ul>
...
Advanced routing and deployment configuration
...
<p>
vercel.json is like **deployment instructions**
