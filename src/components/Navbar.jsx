...
const Navbar = () => {
  return (
    <nav className="flex flex-wrap justify-between items-center px-5 py-5 bg-white border-b border-gray-100 sticky top-0 z-50">
      {/* Brand Name */}
      ...
      <div className="flex gap-8 text-gray-600 font-medium">
        ...
        <Link to="/interview-prep" className="hover:text-black transition">Interview Prep</Link>
      </div>
    </nav>
  );
};
